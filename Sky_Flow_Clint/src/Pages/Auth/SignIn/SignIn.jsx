...
const handleChange = (e) => {
  ...
  return (
    <div className=" relative py-10 lg:py-20">
      ...
      <div className="" onClick={handleAdmin}>
        <AdminInfoButton />
      </div>
      <div
        className="flex flex-col items-center justify-between pt-0 md:pr-10 pb-0 md:pl-10 mt-0 mr-auto mb-0 ml-auto max-w-7xl
          xl:px-5 lg:flex-row">
        <div className="flex flex-col items-center w-full pt-5 pr-10 pb-20 pl-10 lg:pt-20 lg:flex-row">
          <div className="w-full mt-20 mr-0 mb-0 ml-0 relative z-10 max-w-2xl lg:mt-0 lg:w-5/12">
            <div
              className="flex flex-col items-start justify-start pt-10 pr-2 md:pr-10 pb-10 pl-2 md:pl-10 bg-accentA shadow-2xl rounded-xl
                relative z-10">
              ...
              <form
                ...
                <div className="relative ">
                  <div
                    onClick={() => setEye(!eye)}
                    className="absolute  top-1/3 cursor-pointer right-4">
